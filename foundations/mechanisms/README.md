...
具体模型、实现版本和设备结果仍归 model family 与 engineering 条目；具体数据集上的采样收益、训练结果和失败证据归对应 experiment 或 engineering case；DMS 中退化和增强的受控实验见 [DMS degradation and enhancement validation](../../research/experiments/dms-degradation-and-enhancement-validation.md)。
