...
- **Commitment**：R1 是当前唯一主追研究问题；首轮先完成现有训练链、PC 推理链与目标端链的 P0 语义合同审计和 P1 几何验证，再运行 upper-face ROI 信息保真实验。YOLO26 是现代整机观察锚点，现有 keypoint 选型是支撑工作；不扩为完整疲劳状态机、YOLO 教程或所有小目标研究，不下载未审查数据、不训练新模型、不冻结生产阈值。
